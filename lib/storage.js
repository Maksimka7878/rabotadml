...
async function logShift(chatId, userName, startTime, endTime, qualLeads) {
  const sql = getDb();
  await sql`
    INSERT INTO shift_log (chat_id, user_name, start_time, end_time, qual_leads, completed_at)
    VALUES (${chatId}, ${userName}, ${startTime}, ${endTime}, ${qualLeads}, ${Date.now()})
  `;
}
